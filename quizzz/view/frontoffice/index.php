  ...
  <div class="col-lg-4 mb-5">
    <div class="card border-0 bg-light shadow-sm pb-2">
      ...
      <div class="card-footer bg-transparent py-4 px-5">
        ...
        <div class="row">
          <div class="col-6 py-1 text-right border-right">
            <strong>Created_att</strong>
          </div>
          <div class="col-6 py-1"><?= htmlspecialchars($quiz['created_at']) ?></div>
        </div>
      </div>
      <a href="view-quiz.php?id=<?= htmlspecialchars($quiz['id']) ?>" class="btn btn-primary">j</a>
    ...
    >
      <div class="row pt-5">
        <div class="col-lg-3 col-md-6 mb-5">
          ...
          <p>
          A dynamic educational platform that transforms learning into an engaging and personalized experience<br>
