...
<div class="container mt-5">
    ...
    <p>Vous avez <?= round($percentage, 2) ?>% de bonnes réponses</p>
        ...
        <a href="view-quiz.php?id=<?= htmlspecialchars($quizId) ?>" class="btn btn-secondary">Retour à la liste des quiz</a>
        <a href="index.php?id=<?= htmlspecialchars($quizId) ?>" class="btn btn-secondary">Retour à l'accueil</a>
    </div>
</div>
</body>
</html>
