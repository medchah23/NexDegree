...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (!empty($_POST['title']) && !empty($_POST['content'])) {
        ...
        if (strpos($currentScript, 'accueil.php') !== false) {
            $redirectPath = "../frontoffice/accueil.php";
        } elseif (strpos($currentScript, 'posts.php') !== false) {
            $redirectPath = "../backoffice/posts.php";
        } else {
            // Default redirection if script is not identified
            $redirectPath = "../frontoffice/accueil.php";
        }

        // Add query parameters for success message
        $redirectPath .= "?message=Post%20added%20successfully.&messageType=success";
