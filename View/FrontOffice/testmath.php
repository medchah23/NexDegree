  ...
  <body>
      ...
      >
        ...
        >
          <div class="navbar-nav font-weight-bold mx-auto py-0">
            ...
            <a href="class.html" class="nav-item nav-link">Evaluation</a>
    ...
    <form action="submit_test.php" method="post">
      ...
      <div style="margin-bottom: 20px;">
        <p>Question 1 : Décrivez le système solaire.</p>
      ...
      <!-- Question 2 -->
      <div style="margin-bottom: 20px;">
        <p>Question 2 : Quelle est la formule chimique de l'eau ?</p>
      ...
      <!-- Question 3 -->
      <div style="margin-bottom: 20px;">
        <p>Question 3 :Quel est le principal gaz de l'atmosphère terrestre ?</p>
        <label for="question1">Votre réponse :</label>
        <textarea id="question1" name="question1" rows="2" cols="50" style="width: 100%; padding: 10px;"></textarea>
      </div>
      <!-- Question 4 -->
      <div style="margin-bottom: 20px;">
        <p>Question 4 : Qu'est-ce que la photosynthèse ?</p>
        <label for="question1">Votre réponse :</label>
        <textarea id="question1" name="question1" rows="2" cols="50" style="width: 100%; padding: 10px;"></textarea>
      </div>
      <!-- Question 5 -->
      <div style="margin-bottom: 20px;">
        <p>Question 5 :Qui a proposé la théorie de l'évolution par sélection naturelle ?</p>
        <label for="question1">Votre réponse :</label>
        <textarea id="question1" name="question1" rows="2" cols="50" style="width: 100%; padding: 10px;"></textarea>
      </div>
      <!-- Submit Button -->
