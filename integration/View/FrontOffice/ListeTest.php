...
<html lang="en">
  ...
  <body>
    ...
    <div style="text-align: center; margin-bottom: 30px;">
      ...
      <a href="ListeTest.php?matiere=Informatique" class="btn btn-primary m-2">Informatique</a>
      <a href="ListeTest.php?matiere=Physics" class="btn btn-primary m-2">Physics</a>
