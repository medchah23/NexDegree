...
<img class="navbar-brand" src="assets/img/esprit.png" alt="logo-esprit" width="50%" height="30%"/>
  ...
  <footer id="footer" class="footer">
    ...
    <script>
      ...
      // Ajoutez l'événement keyup pour valider au fur et à mesure de la saisie
...
descriptionElement.addEventListener("keyup", function() {
    ...
    // Vérifier si la longueur est inférieure à 10 caractères
    if (descriptionErrorValue.length < 8) {
        ...
        // Vérifier le format (lettres et espaces uniquement)
