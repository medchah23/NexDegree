document.addEventListener("DOMContentLoaded", function () {
    var durationElement = document.getElementById("duree");
    var descriptionElement = document.getElementById("description2");
    var maxScoreElement = document.getElementById("noteMax");
  
    
  
    durationElement.addEventListener("keyup", function () {
      var durationErrorElement = document.getElementById("duree_error");
